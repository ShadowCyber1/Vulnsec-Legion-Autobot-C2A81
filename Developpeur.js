...
module.exports.run = async function({ api, event, args }) {
		...
		const prefix = "😐";
		const CREATORLINK = "https://www.facebook.com/profile.php?id=61553917146801";
		const BOTCREATOR = "VulnSec Legion";
		const BOTNAME = "💢𝓥𝓤𝓛𝓝𝓢𝓔𝓒-𝓑𝓞𝓣💢";
		const FILESOWNER = "VulnSec Legion";
